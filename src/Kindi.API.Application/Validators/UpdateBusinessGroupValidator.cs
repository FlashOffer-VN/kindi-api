...
public class UpdateBusinessGroupValidator : AbstractValidator<UpdateBusinessGroupDto>
{
    public UpdateBusinessGroupValidator(IStringLocalizer<SharedResource> localizer)
    {
        RuleFor(x => x.Name)
